...
import { Camera, Compass, Map, TrendingUp } from "lucide-react";
import { siteCopy } from "@/lib/content";
import { flowStepImages } from "@/lib/media";
import { cn, prefersReducedMotionSafe } from "@/lib/utils";

const STEP_ICONS = [Compass, Map, Camera, TrendingUp];
...
export function StickyFlow() {
  ...
  return (
    <section id="how" ref={sectionRef} className="relative h-[280svh] bg-flow-black lg:h-[400vh]">
        ...
        <div className="relative mx-auto grid w-full max-w-7xl flex-1 items-start gap-5 px-5 py-6 pt-[4.5rem] lg:grid-cols-[0.95fr_1.05fr] lg:items-center lg:gap-14 lg:py-20 lg:pt-24 lg:px-8">
          ...
          <div className="relative order-1 lg:order-2">
            <div
              ...
              aria-hidden="true"
            />
            <div ref={stackRef} className="relative mx-auto w-full max-w-xl lg:max-w-2xl" style={{ willChange: "transform" }}>
