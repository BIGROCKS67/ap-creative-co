    ...
    <div className="pointer-events-none absolute inset-0 z-20">
      ...
      >
        ...
        <div className="pointer-events-auto mt-10 flex items-center gap-4">
          ...
          <a
            href="#terminal"
            className="rounded-full border border-white/25 px-7 py-3 text-sm font-semibold text-white backdrop-blur transition-[border-color,background-color,transform] duration-200 [transition-timing-function:var(--ease-out)] hover:border-[var(--ch-acid)]/60 hover:bg-white/5 active:scale-[0.97]"
          >
            Explore
          </a>
        </div>
