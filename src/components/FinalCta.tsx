...
export function FinalCta() {
  ...
  return (
    <section id="join" className="cv-auto mm-surface-light mm-section relative scroll-mt-24 overflow-hidden border-t border-black/5">
      <div
        className="pointer-events-none absolute left-1/2 top-1/2 h-[420px] w-[620px] max-w-[120vw] -translate-x-1/2 -translate-y-1/2 rounded-full bg-flow-green/15 blur-[120px] motion-safe:animate-[beam-pulse_5s_ease-in-out_infinite]"
        aria-hidden="true"
      />
